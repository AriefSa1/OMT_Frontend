...
export async function fetchShopeeAds() { return cached('/shopee/ads', 30000); }
...
export async function generateAITitle(productName) { return request('/ai/generate-title', { method: 'POST', body: JSON.stringify({ productName }) }); }
export async function generateAIStoreCopy(storeName) { return request('/ai/generate-store-copy', { method: 'POST', body: JSON.stringify({ storeName }) }); }
export async function generateAIAdsKeywords(campaignName) { return request('/ai/generate-ads-keywords', { method: 'POST', body: JSON.stringify({ campaignName }) }); }
